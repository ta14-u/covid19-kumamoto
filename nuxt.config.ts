...
const config: Configuration = {
  ...
  head: {
    ...
    titleTemplate: '%s | 熊本県【非公式】新型コロナウイルス感染症対策サイト',
    meta: [
      { charset: 'utf-8' },
      ...
      },
      {
        ...
        content: '熊本県【非公式】新型コロナウイルス感染症対策サイト'
      },
      { hid: 'og:type', property: 'og:type', content: 'website' },
      {
        hid: 'og:url',
        property: 'og:url',
        content: 'https://stop-covid19-kumamoto.netlify.com/'
      },
      {
        hid: 'og:title',
        property: 'og:title',
      ...
      },
      {
        hid: 'og:image',
        property: 'og:image',
        content: 'https://stop-covid19-kumamoto.netlify.com/ogp.png'
      },
      {
        hid: 'twitter:card',
        name: 'twitter:card',
